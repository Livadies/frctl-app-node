...
- Android‑приложение 1.3.0: GitHub + Hugging Face, Room‑офлайн, избранное, список установленных, поиск с историей и проверка обновлений;
...
- FRCTL Node 0.5.0: allowlist, закрепление SSH host key, фиксированные workflow, системное подтверждение, HMAC-аудит, SSE и экспорт журнала;
...
```text
GitHub API ─┐
            ├─ единый нормализованный каталог ─┬─ Android 1.3
HF API ─────┘                                  ├─ Windows 0.4 / Node 0.5
                                               └─ публичный Space
